...
export default function Footer() {
  return (
    <footer className="relative py-16">
      {/* Blue Gradient Glowing Background */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-400/30 via-blue-600/10 to-indigo-500/30 blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link className="hover:text-blue-500 transition" href="/tools">AI Tools Directory</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/news">Latest News</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/deals">Exclusive Deals</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/reviews">Reviews & Guides</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/submit-tool">Submit a Tool</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link className="hover:text-blue-500 transition" href="/categories/content-creation">Content Creation</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/categories/code-dev">Code & Development</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/categories/design">Design & Art</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/categories/business">Business & Productivity</Link></li>
              <li><Link className="hover:text-blue-500 transition" href="/categories/data">Data & Analytics</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-4">
              <Link href="https://twitter.com" target="_blank" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition">
                <Twitter className="w-5 h-5" />
              </Link>
              <Link href="https://linkedin.com" target="_blank" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition">
                <Linkedin className="w-5 h-5" />
              </Link>
              <Link href="https://github.com" target="_blank" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition">
                <Github className="w-5 h-5" />
              </Link>
              <Link href="https://discord.com" target="_blank" className="text-gray-600 dark:text-gray-400 hover:text-blue-500 transition">
