...
<section className="w-full py-20 relative overflow-hidden">
  ...
  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[80%] h-full 
                  bg-gradient-to-t from-green-400/30 via-blue-400/20 to-transparent blur-3xl">
  </div>
    ...
    <form className="mt-6 flex flex-col sm:flex-row items-center gap-3">
      <input
        ...
        className="w-full sm:flex-1 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 
                   focus:ring-2 focus:ring-green-400 dark:focus:ring-blue-400 focus:outline-none 
      ...
      <button
        ...
        className="px-6 py-3 rounded-lg text-white font-medium 
                   ...
                   hover:shadow-lg hover:shadow-green-400/30 dark:hover:shadow-blue-400/30 
